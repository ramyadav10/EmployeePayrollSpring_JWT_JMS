...
public class EmpayController 
{
	...
	public ResponseEntity<String> addEmployeePayRollData(@Valid @RequestBody EmployeeDTO employeeDTO) throws Exception
	{
		String token = employeeService.addRecord(employeeDTO);
		ResponseDTO dto = new ResponseDTO("Record added successfully",token);
